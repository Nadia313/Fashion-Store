	...
	<table align="center" cellpadding="5" cellspacing="5" border="1">
		...
		<%
			try {
				...
				String sql = "SELECT seller, COUNT(*) posts FROM item WHERE date >= '2018-05-01' GROUP BY seller HAVING posts = (SELECT COUNT(*) posts FROM item WHERE date >= '2018-05-01' GROUP BY seller ORDER BY posts DESC LIMIT 1 );";
